...
ɪ ᴀᴍ ᴀ ᴘᴏᴡᴇʀғᴜʟ ᴀᴜᴛᴏғɪʟᴛᴇʀ ʙᴏᴛ. ʏᴏᴜ ᴄᴀɴ ғɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʏᴏᴜ ᴡᴀɴᴛ ᴡɪᴛʜ ᴀ sɪᴍᴘʟᴇ sᴇᴀʀᴄʜ. ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ sᴛᴀʀᴛ ᴇᴀʀɴɪɴɢ ᴀs ᴡᴇʟʟ...</blockquote></b>
"""
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/anime_zou">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/anime_zou">[ ᴀɴɪᴍᴇxᴢᴏᴜ ]</a></b>"""
